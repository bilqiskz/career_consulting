                    ...
                    <div class="form-group col">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1">
                            <?php foreach ($profil as $value) : ?>
                                <option <?= (($value->jurusan == user()->jurusan) ? 'selected ' : ' ') ?> value="<?= $value->jurusan; ?>"><?= $value->jurusan; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group col">
                        ...
                        <select class="form-control" id="exampleFormControlSelect2">
                            <?php foreach ($profil as $value) : ?>
                                <option <?= (($value->kelas == user()->kelas) ? 'selected ' : ' ') ?> value="<?= $value->kelas; ?>"><?= $value->kelas; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="form-group col">
                        ...
                        <select class="form-control" id="exampleFormControlSelect1">
                            <?php foreach ($profil as $value) : ?>
                                <option <?= (($value->rombel == user()->rombel) ? 'selected ' : ' ') ?> value="<?= $value->rombel; ?>"><?= $value->rombel; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
